...
const UploadCerts = () => {
  ...
  return (
    <div className='w-full h-full p-5'>
            ...
            <CertifcateConatainer name={selectedData?.name ? selectedData.name.toUpperCase() : 'No Certificate Selected'} />
        ...
        </div>
        {
            loading ? <div> <h2>loadin...</h2> </div>
             ...
             <div className='w-[1/2]  grid grid-cols-2 gap-5 mt-10'>
                ...
                {usersWithNoCerts.map(val => <div className=' flex items-center ' key={val.id}>

                 
                    <div  className='flex w-full flex-col gap-2'>
                    <Label htmlFor="downloadCert">{val.name}</Label>
                        <Button>
                            <button type='button' className='text-xl w-[100px] ' onClick={(e)  => handleSelectedData({...val})} >SELECT</button>
                        </Button>
                    </div>
                </div>)}
             </div>
             ...
             <div className='w-1/2 h-full'>
                        ...
                        <Button>
                            <button type='button' className='text-xl px-3 py-2 ' onClick={ handleDownload} >DOWBLOAD CERTIFICATE</button>
                        </Button>
