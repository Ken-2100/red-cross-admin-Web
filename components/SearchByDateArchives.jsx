...
const SearchByDateArchives = () => {
  ...
  const { setSearchDataArchives } = useContext(SearchArrayDataProvider);
  ...
  useEffect(() => {
    if (date) {
      ...
      // Set the formatted date in the provider
      setSearchDataArchives(formattedDate);
    }
  }, [date, setSearchDataArchives]);
